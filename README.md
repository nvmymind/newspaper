...
여러 신문사의 사설을 한곳에서 모아 보고, **날짜별·신문사별**로 조회할 수 있는 웹 서비스입니다.

## 기능

- **사설 수집**: 조선일보, 동아일보, 한겨레, 중앙일보, 경향신문, 매일경제, 한국경제, 서울신문 사설 목록을 한 번에 수집
- **날짜별 보기**: 당일뿐 아니라 과거 날짜의 사설도 조회
- **신문사별 필터**: 특정 신문사만 골라서 보기
- **원문 링크**: 각 항목 클릭 시 해당 신문사 기사 페이지로 이동
...
- 첫 접속 후 **「오늘 사설 가져오기」** 버튼을 누르면 각 신문사 사설 목록을 수집해 DB에 저장합니다.
- 같은 기사(URL)는 한 번만 저장되므로, 매일 버튼을 눌러 두면 날짜가 쌓여서 **과거 날짜**로도 조회할 수 있습니다.
